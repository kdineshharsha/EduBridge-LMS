...
import { User, Bell, Lock, BookOpen, Plus, Settings, Megaphone } from "lucide-react";
...
export default function InstructorSettings() {
    ...
    return (
        <div className="min-h-screen w-full ">
            <div className="bg-white w-full rounded-lg  md:p-6 py-6 px-2 h-full">
                <div className="mb-8">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 text-sm mt-1">
                                    Manage and organize your profile
                                </p>
                            </div>
                        </div>
                ...
                <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 mb-8">
                    ...
                    />
                    <TabButton
                        label="Announcements / Promo"
                        icon={Megaphone}
                        active={activeTab === "anouncements"}
                        onClick={() => setActiveTab("anouncements")}
                    />
                </div>
                ...
                <div className="mt-6">
                    ...
                    {activeTab === "anouncements" && <Announcements />}
                </div>
            </div>
        </div>
    );
...
function ProfileSettings({ user }) {
    ...
    return (
        <div className="space-y-6 ">
            <h2 className="text-lg font-semibold text-gray-800">Profile InstructorSettings</h2>
...
function Announcements() {
    return (
        <div className="space-y-6">
            ...
            <p className="text-gray-600">Manage your announcements and promotional content here.</p>
            {/* Add your announcement management UI here */}
        </div>
    );
}